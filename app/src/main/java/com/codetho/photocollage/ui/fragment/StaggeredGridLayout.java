...
public class StaggeredGridLayout extends RecyclerView.LayoutManager {
    ...
    public StaggeredGridLayout(GridSpanLookup spanLookup, int columns, float cellAspectRatio) {
    ...
    public StaggeredGridLayout(
            Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.StaggeredGridLayoutManager, defStyleAttr, defStyleRes);
        columns = a.getInt(R.styleable.StaggeredGridLayoutManager_spanCount, 1);
        parseAspectRatio(a.getString(R.styleable.StaggeredGridLayoutManager_aspectRatio));
        // TODO use this!
        a.recycle();
        setAutoMeasureEnabled(true);
    }
